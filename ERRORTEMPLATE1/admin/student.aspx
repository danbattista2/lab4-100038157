<%@ Page Title="Student Details" Language="C#" MasterPageFile="~/Monday.Master" AutoEventWireup="true" CodeBehind="student.aspx.cs" Inherits="ERRORTEMPLATE1.student" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <h2>Courses</h2>
    <asp:GridView ID="grdCourses" runat="server" DataKeyNames="EnrollmentID" AutoGenerateColumns="false" CssClass="table table-striped table-hover"
