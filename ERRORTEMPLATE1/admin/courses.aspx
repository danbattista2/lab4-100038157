<%@ Page Title="Courses" Language="C#" MasterPageFile="~/monday.Master" AutoEventWireup="true" CodeBehind="courses.aspx.cs" Inherits="ERRORTEMPLATE1.courses" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView OnRowDataBound="grdCourses_RowDataBound" ID="grdCourses" runat="server" AutoGenerateColumns="false" CssClass="table table-striped table-hover sort display" 
