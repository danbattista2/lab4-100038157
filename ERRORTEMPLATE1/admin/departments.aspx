<%@ Page Title="Contoso University - Departments" Language="C#" MasterPageFile="~/monday.Master" AutoEventWireup="true" CodeBehind="departments.aspx.cs" Inherits="ERRORTEMPLATE1.departments" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:GridView ID="grdDepartments" OnRowDataBound="grdDepartments_RowDataBound" runat="server" CssClass="table table-striped table-hover sort display"
        ...
        OnSorting="grdDepartments_Sorting" >
        <Columns>        
